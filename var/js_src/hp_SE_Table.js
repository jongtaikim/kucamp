...
nhn.husky.SE_Table = $Class({
	...
	$ON_MSG_APP_READY : function(){
		this.oApp.exec("REGISTER_UI_EVENT", ["table", "click", "ST_SHOW_TOOLBAR_LAYER"]);
	...
	$ON_ST_SHOW_TOOLBAR_LAYER : function(){
		this.oApp.exec("RECORD_UNDO_ACTION_FORCED", ["KEYPRESS"]);
		
		this.oSelection = this.oApp.getSelection();
		this.sInsertionPointBookmark = this.oSelection.placeBookmark();
		this._showNewTable();
	...
	$ON_ST_INSERT_TABLE : function(){
		...
		this.oSelection.moveToBookmark(this.sInsertionPointBookmark);
	...
	$ON_HIDE_ACTIVE_LAYER : function(oTableLayer){
		if(oTableLayer == this.elDropdownLayer){
			this._removeBookmark();
		}
	},
	...
	_removeBookmark : function(){
		if(this.sInsertionPointBookmark){
			this.oSelection.removeBookmark(this.sInsertionPointBookmark);
			this.sInsertionPointBookmark = "";
		}
	},
