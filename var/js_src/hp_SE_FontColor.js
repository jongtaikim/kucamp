...
nhn.husky.SE_FontColor = $Class({
	...
	$ON_MSG_APP_READY : function(){
		this.oApp.exec("REGISTER_UI_EVENT", ["fontColor", "click", "SHOW_FONTCOLOR_LAYER"]);
	},
	
	$ON_SHOW_FONTCOLOR_LAYER : function(){
		this.oApp.exec("SHOW_COLOR_PALETTE", ["APPLY_FONTCOLOR", this.elDropdownLayer]);
