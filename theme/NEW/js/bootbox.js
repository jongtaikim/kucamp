...
(function (root, factory) {
    ...
    var templates = {
        dialog:
        "<div class='bootbox modal bootbox_modal' tabindex='-1' role='dialog' style='font-size:16px;margin:auto;z-index:89998;'>" +
        ...
        "<h5 class='modal-title' style='font-size:16px'></h5>" +
        "</div>",
        footer:
            "<div class='modal-footer'></div>",
        closeButton:
            "<button type='button' class='bootbox-close-button close' style='font-size:30px'>&times;</button>",
        form:
        ...
        inputs: {
            ...
            number:
                "<input class='bootbox-input bootbox-input-text form-control' autocomplete=off type=number />",
            textarea:
