...
if($skin =="B2_board"){
	$orders = " order by  num_group asc ";
}else{
	$orders = " order by  num_group desc ";
...
str_title, str_email, num_hit, num_file, num_comment, num_input_pass, dt_date, str_category, str_thumb,num_rank, str_tmp1, str_tmp2, str_tmp3,  str_tmp4, str_tmp5, str_tmp6,  str_tmp7, str_tmp8, str_tmp9, str_tmp10,str_nick,str_mov, str_view
FROM
$ARTICLE_TABLE
WHERE
num_oid=$oid AND num_mcode=$mcode  AND  num_notice=0  $listPsql    $whereadd $orders
...
SELECT
num_mcode, num_serial, num_notice, num_group, num_step, num_depth, str_user, str_name, str_pass, str_hak, str_text,
str_title, str_email, num_hit, num_file, num_comment, num_input_pass, dt_date, str_thumb, str_tmp1, str_tmp2, str_tmp3,  str_tmp4, str_tmp5, str_tmp6,  str_tmp7, str_tmp8, str_tmp9, str_tmp10,str_nick,str_mov,str_category
FROM
$ARTICLE_TABLE
WHERE
num_oid=$oid AND  num_notice=1  and num_mcode=$mcode    $whereadd  $orders
";
...
num_mcode, num_serial, num_notice, num_group, num_step, num_depth, str_user, str_name, str_pass, str_hak, str_text,
str_title, str_email, num_hit, num_file, num_comment, num_input_pass, dt_date,str_category, str_thumb, str_tmp1, str_tmp2, str_tmp3,  str_tmp4, str_tmp5, str_tmp6,  str_tmp7, str_tmp8, str_tmp9, str_tmp10,str_nick,str_mov
FROM
$ARTICLE_TABLE
WHERE
num_oid=$oid AND num_notice=2  $whereadd $orders 
";
