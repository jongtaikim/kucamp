...
if($data = $DB->sqlFetch($sql)) { }else{ WebApp::moveBack('글이 없습니다.');}
...
";
		...
		'<img src="'.$file['file_url'].'?nocount=1'.'" border="0" align="center" '.
		'width ='.$img_w.'  vspace="5" alt="'.$data[str_title].'의 첨부이미지 '.$fnumber.'"></a></center><br>';
		...
		'<img src="'.$file['file_url'].'?nocount=1'.'" border="0" align="center" '.
		'width ='.$img_w2.'  vspace="5"  alt="'.$data[str_title].'의 첨부이미지 '.$fnumber.'"></a><br>';
