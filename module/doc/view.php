...
if (!$body) {
	$body = '<div style="height:200px"><center>내용이 없습니다.<br><a href=/doc.admin.edit?mcode='.$mcode.'><img src=/html/doc_board/skin/A_board/image/btn_write.gif /></a></center></div>';
}else{
	$body  = "<div  class='smartOutput'>".$body."</div><center><br><a  href='/doc.admin.edit?mcode=".$mcode."#'><br><img src=/html/doc_board/skin/A_board/image/btn_modify.gif /></a></center>";
}
