	...
	case "POST":
		if($_POST['preview']) {
			...
			$sql = "Insert into ".TAB_POPUP."
			 ...
			 Values
			   ("._OID.", 'host', ".$id.", '$str_title', '$str_text', '$str_skin', 'A',  '".$_POST['num_width']."', '".$_POST['num_height']."', $num_left, $num_top, ".mktime().",'".mkday($dt_start_date)."','".mkday($dt_end_date)."', 'N', '$str_e', '$str_m' , '$str_h','$num_kill','$str_url')
			";
