...
mtDropDown.hideDelay = 30; 
mtDropDown.slideTime = 30; 
...
function addItem(sText, sUrl, Menu) {
var item = new mtDropDownItem(sText, sUrl, this);
item._index = this.items.length;

this.items[item.menu] = Menu;//
...
admin_content.location.href = _this.items[this._index].url;
if (_this.items[this.menu])
{
admin_menu.location.href = '/bs.admin.menu?part=' + _this.items[this.menu] ;
}
}
//childMenuSet.hideMenu(childMenus[this._index]);
...
'<div class="content" ><table class="items" width="120" cellpadding="0" cellspacing="0" border="0" style="table-layout:fixed" onMouseover="divmsover(Tmenuov);"   onMouseout="divmsout(Tmenuou);">' + 
aHtml.join('') + 
'</table>' + 
