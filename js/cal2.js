...
//사용법
// <img src="../images/icn-calendar.gif" onclick="Calendar_D(document.all.WriteDate)" style="cursor:hand;">
...
function Show_cal(sYear, sMonth, sDay) {
	...
	for (var optYear=(/*intThisYear-2*/2000); optYear<(NowThisYear+10); optYear++) {
...
function Show_cal_M(sYear, sMonth) {
	...
	for (var optYear=(/*intThisYear-2*/2000); optYear<(intThisYear+10); optYear++) {
			Cal_HTML += "		<option value='"+optYear+"' ";
			if (optYear == intThisYear) Cal_HTML += " selected>\n";
			else Cal_HTML += ">\n";
			Cal_HTML += optYear+"</option>\n";
