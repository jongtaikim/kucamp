...
<input type="text" size="12" class="fom01" name="'.$attr['name'].'" id="'.$attr['name'].'" value="'.$attr['value'].'" '.($attr['readonly'] ? 'readonly ': '').'/>&nbsp;<img src="image/icon/datepicker.gif" id="datepicker-'.$attr['name'].'" align="absmiddle" style="cursor:pointer">
