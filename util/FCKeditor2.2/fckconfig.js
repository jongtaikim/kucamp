...
FCKConfig.ToolbarSets["Simple"] = [
        ['Source','-','Undo','Redo','Cut','Copy','Paste','-','Link','Unlink'],
		['Templates','Table','Image','Flash','Smiley','SpecialChar'],
		['Bold','Underline','-','JustifyLeft','JustifyCenter','JustifyRight','-','OrderedList','UnorderedList'],
		['TextColor','FontName','FontSize','-','About']
] ;
