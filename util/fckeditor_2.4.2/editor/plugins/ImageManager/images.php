...
function drawDirs($list, &$manager) 
{
	...
	{ ?>
		...
		<td class="edit">
			<a href="images.php?dir=<?php echo $relative; ?>&amp;deld=<?php echo rawurlencode($path); ?>" title="<?php _e("Trash","ImageManager"); ?>" onclick="return confirmDeleteDir('<?php echo $dir['entry']; ?>', <?php echo $dir['count']; ?>);"><img src="img/edit_trash.gif" height="15" width="15" alt="<?php _e("Trash","ImageManager"); ?>"/></a>
			<?php echo $dir['entry']; ?>
		</td>
		</tr></table></td>
	  <?php 
...
<table width="100%">
  <tr>
    <td class="noResult"><?php _e("No Images Found","ImageManager"); ?></td>
  </tr>
</table>
<?	
}
...
<table width="100%">
  <tr>
    <td class="error"><?php _e("Invalid base directory:","ImageManager"); ?> <?php echo $manager->config['base_dir']; ?></td>
  </tr>
</table>
<?php
}
...
<html>
<head>
	<title><?php _e("Image List","ImageManager"); ?></title>
...
<script type="text/javascript">
	<?php require "assets/images_js.php" ?>
</script>
</head>
