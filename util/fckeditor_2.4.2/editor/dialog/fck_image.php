...
<table cellspacing="0" cellpadding="0" width="100%" height="100%" border="0">
	<tr>
		...
		<td><!-- <span fckLang="DlgImgUpload">업로드</span><br> -->
			<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%" ID="Table5-2"><tr>
				...
				<td>&nbsp;
					<input id="btnUpload" type="button"  value="파일찾기" style="font-family: 'Microsoft Sans Serif' , Tahoma, Arial, Verdana, Sans-Serif;font-size:9pt;width:70px;height:22px;" onclick="add_file();" NAME="btnUpload">
					<input id="btnUpload2" type="button" value="업로드" style="font-family: 'Microsoft Sans Serif' , Tahoma, Arial, Verdana, Sans-Serif;font-size:9pt;width:70px;height:22px;" onclick="uploadFile();" NAME="btnUpload2">
				</td>
			</tr>
			</table>
		</td>
...
<body bottommargin="0" leftmargin="0" topmargin="0" rightmargin="0" bgcolor="#F1F1E3">
	...
	<tr>
		<td style="font-size:9pt;" align="center"><span fckLang="DlgImgDisableUpload">Upload Disabled</span></td>
	</tr>
	</table>
</body>
<script>
